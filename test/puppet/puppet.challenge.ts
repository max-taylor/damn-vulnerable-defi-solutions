...
describe("[Challenge] Puppet", function () {
  ...
  it("Execution", async function () {
    ...
    // TODO: I am unsure how to pass this challenge without using the deployer for this. If we use the player then they have executed 2 transactions and the test fails
