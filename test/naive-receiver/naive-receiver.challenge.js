...
describe("[Challenge] Naive receiver", function () {
  ...
  // The lender pool can be called on behalf of anyone for a provided receiver. The receiver ensures only the pool can call it's onFlashLoan hook, but the pool's flashLoan method is open to anyone. The fee is 1 ETH, so the exploit needs to be run 10 times to reclaim the ETH. Contract simply does it in a single transaction
